    ...
    public class AIVisionService
    {
        ...
        public async Task<string> AnalyzeImagesAsync(List<string> imageUrls, string apiKey)
        {
            ...
            try
            {
                ...
                parts.Add(new { text = "Ты — циничный и опытный перекупщик смартфонов. По умолчанию каждое объявление — это обычная рядовая цена. Твоя задача — найти подвох, проверить возраст устройства и доказательства косметических/физических дефектов. Если устройство старое (например, Redmi 9), нормальная цена — это не аномальная скидка. Оцени состояние устройства по этим фото. Ищи трещины, царапины, разбитые стекла, выгорания экрана, неродные коробки или следы вскрытия (сорванные болты). Отвечай кратко, дай итоговый вердикт о состоянии телефона. Если фото мутные, так и напиши." });
